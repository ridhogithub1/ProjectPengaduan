...
export default function TambahPengaduan({ auth }) {
    const { data, setData, post, processing, errors, recentlySuccessful } = useForm({
        name: '',
        lokasi: '',
        jenis: 'Urgent', // Set default value for jenis
        tanggal: '',
        image: null,
        status: 'in pending',
    });
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            <section className="max-w-7xl mx-auto p-8 mt-8 bg-white rounded shadow-lg">
                <header>
                    <h2 className="text-xl font-medium text-gray-900 dark:text-gray-100">Tambah Pengaduan</h2>
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Tambahkan pengaduan baru Anda di sini.
                    </p>
                </header>
                ...
                <form onSubmit={submit} className="mt-6 space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        <PrimaryButton className="bg-purple-600 hover:bg-purple-700 px-4 py-2 text-sm" disabled={processing}>Tambah</PrimaryButton>
