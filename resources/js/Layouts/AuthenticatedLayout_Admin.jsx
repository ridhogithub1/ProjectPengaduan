        ...
        <div className={`flex h-screen bg-gray-50 dark:bg-gray-900 ${isSideMenuOpen ? 'overflow-hidden' : ''}`}>
            ...
            <aside className="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
                <div className="py-4 text-gray-500 dark:text-gray-400">
                    ...
                    <ul className="mt-6">
                        ...
                        <NavLink href="/dashboard_admin" active={url.startsWith('/dashboard')}>
            ...
            >
                <div className="py-4 text-gray-500 dark:text-gray-400">
                    ...
                    <ul className="mt-6">
                        <NavLink href="/dashboard" active={url.startsWith('/dashboard_admin')}>
                            <span className="ml-4">Dashboard</span>
                        </NavLink>
                        <NavLink href="/pengaduan" active={url.startsWith('/pengaduan_admin')}>
                            <span className="ml-4">Pengaduan</span>
                        </NavLink>
                        <NavLink href="/diskusi" active={url.startsWith('/diskusi')}>
                            <span className="ml-4">Diskusi</span>
